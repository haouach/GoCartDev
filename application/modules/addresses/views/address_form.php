    ...
    <?php echo form_open('addresses/form/'.$id, ['id'=>'addressForm']);?>
        <div class="col-nest">
            ...
            <label><?php echo lang('address_company');?></label>
                <?php echo form_input(['name'=>'company', 'value'=> set_value('company',$company)]);?>
            </div>
        </div>
        ...
        <div class="col-nest">
            <div class="col" data-cols="1/2" data-medium-cols="1/2" data-small-cols="1/2">
                ...
                <?php echo form_input(['name'=>'firstname', 'value'=> set_value('firstname',$firstname)]);?>
            </div>

            <div class="col" data-cols="1/2" data-medium-cols="1/2" data-small-cols="1/2">
                <label class="required"><?php echo lang('address_lastname');?></label>
                <?php echo form_input(['name'=>'lastname', 'value'=> set_value('lastname',$lastname)]);?>
            </div>
        </div>
        ...
        <div class="col-nest">
            <div class="col" data-cols="1/2" data-medium-cols="1/2" data-small-cols="1/2">
                ...
                <?php echo form_input(['name'=>'email', 'value'=>set_value('email',$email)]);?>
            </div>
            <div class="col" data-cols="1/2" data-medium-cols="1/2" data-small-cols="1/2">
                <label class="required"><?php echo lang('address_phone');?></label>
                <?php echo form_input(['name'=>'phone', 'value'=> set_value('phone',$phone)]);?>
            </div>
        </div>
        <div class="col-nest">
            <div class="col" data-cols="1">
                ...
                <?php
                echo form_input(['name'=>'address1', 'value'=>set_value('address1',$address1)]);
                echo form_input(['name'=>'address2', 'value'=> set_value('address2',$address2)]);
                ?>
            </div>
        </div>
        <div class="col-nest">
            <div class="col" data-cols="1">
                ...
                <?php echo form_dropdown('country_id', $countries_menu, set_value('country_id', $country_id), 'id="country_id"');?>
            </div>
        </div>
        <div class="col-nest">
            <div class="col" data-cols="2/5" data-medium-cols="2/5" data-small-cols="1/3">
                ...
                <?php echo form_input(['name'=>'city', 'value'=>set_value('city',$city)]);?>
            </div>
            <div class="col" data-cols="2/5" data-medium-cols="2/5" data-small-cols="1/3">
                <label><?php echo lang('address_state');?></label>
                <?php echo form_dropdown('zone_id', $zones_menu, set_value('zone_id', $zone_id), 'id="zone_id"');?>
            </div>
            <div class="col" data-cols="1/5" data-medium-cols="1/5" data-small-cols="1/3">
                <label class="required"><?php echo lang('address_zip');?></label>
                <?php echo form_input(['maxlength'=>'10', 'name'=>'zip', 'value'=> set_value('zip',$zip)]);?>
            </div>
        </div>
