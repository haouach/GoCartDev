...
class AdminSettings extends Admin {
    ...
    public function index()
    {
        ...
        \CI::form_validation()->set_rules('google_product_fields', 'lang:google_product_fields');
        ...
        else
        {
            ...
            $save = \CI::input()->post();
            //fix boolean values
            $save['ssl_support'] = \CI::input()->post('ssl_support');
            $save['google_product_fields'] = \CI::input()->post('google_product_fields');
            $save['require_login'] = \CI::input()->post('require_login');
            $save['new_customer_status'] = \CI::input()->post('new_customer_status');
            $save['allow_os_purchase'] = \CI::input()->post('allow_os_purchase');
            $save['tax_shipping'] = \CI::input()->post('tax_shipping');
