...
<group><?php $group = \CI::Customers()->get_group($customer['id']); echo ($group) ? $group->name : ''  ?></group>
<billing_address>
    <?php 
        $bill_address = \CI::Customers()->get_address($customer['default_billing_address']);
        if($bill_address)
        {
...
<shipping_address>
    <?php 
        $ship_address = \CI::Customers()->get_address($customer['default_shipping_address']);
        if($ship_address)
        {
