...
<div class="col-nest">
    <div class="col" data-cols="1/3">
        <?php echo form_open('my-account'); ?>
            ...
            <?php echo form_input(['name'=>'company', 'value'=> set_value('company', $customer['company'])]);?>
                
            <div class="col-nest">
            
                <div class="col" data-cols="1/2">
                    <label for="account_firstname"><?php echo lang('account_firstname');?></label>
                    <?php echo form_input(['name'=>'firstname', 'value'=> set_value('firstname', $customer['firstname'])]);?>
                </div>

                <div class="col" data-cols="1/2">
                    <label for="account_lastname"><?php echo lang('account_lastname');?></label>
                    <?php echo form_input(['name'=>'lastname', 'value'=> set_value('lastname', $customer['lastname'])]);?>
                </div>
            
                <div class="col" data-cols="1/2">
                    <label for="account_email"><?php echo lang('account_email');?></label>
                    <?php echo form_input(['name'=>'email', 'value'=> set_value('email', $customer['email'])]);?>
                </div>
            
                <div class="col" data-cols="1/2">
                    <label for="account_phone"><?php echo lang('account_phone');?></label>
                    <?php echo form_input(['name'=>'phone', 'value'=> set_value('phone', $customer['phone'])]);?>
                </div>
            </div>
