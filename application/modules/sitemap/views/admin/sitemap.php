<div class="row">
    <div class="span12">
        <button class="btn" id="generateButton" onclick="generateSitemap()">Generate Sitemap</button>
...
{
    $.post('<?php echo site_url('admin/sitemap/generate-products'); ?>', {'limit':count, 'offset':count+100}, function(data){
