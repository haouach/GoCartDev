<div class="row">
    ...
    <div class="span6">
        <form class="form-inline pull-right">
            <input class="span2 datepicker" type="text" name="best_sellers_start" placeholder="<?php echo lang('from');?>"/>
            <input class="span2 datepicker" type="text" name="best_sellers_end" placeholder="<?php echo lang('to');?>"/>
