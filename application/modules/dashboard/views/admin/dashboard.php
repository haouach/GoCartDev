...
<table class="table table-striped">
	...
	<tr>
		<td  class="gc_cell_left"><a href="<?php echo site_url('admin/orders/order/'.$order->id); ?>"><?php echo $order->order_number; ?></a></td>
...
<div class="row">
	<div class="span12" style="text-align:center;">
		<a class="btn btn-large" href="<?php echo site_url('admin/orders');?>"><?php echo lang('view_all_orders');?></a>
	</div>
</div>
...
<div class="row">
	<div class="span12" style="text-align:center;">
		<a class="btn btn-large" href="<?php echo site_url('admin/customers');?>"><?php echo lang('view_all_customers');?></a>
	</div>
</div>