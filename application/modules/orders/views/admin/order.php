...
<div id="notification_form" class="row" style="display:none;">
    <div class="span12">
        <?php echo form_open('admin/orders/sendNotification/'.$order->id);?>
            <fieldset>
...
<fieldset>
    <div class="row" style="margin-top:20px;">
        ...
        <div class="span4">
            ...
            <?php
            echo form_dropdown('status', config_item('order_statuses'), $order->status, 'class="span4"');
            ?>
...
<table class="table table-striped">
    ...
    <tbody>
        ...
        <tr>
            <td><strong><?php echo lang('gift_card_discount');?></strong></td>
            <td colspan="3"></td>
