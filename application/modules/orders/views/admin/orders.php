		...
		<div class="row">
			...
			<div class="span8">
				<?php echo form_open('admin/orders', 'class="form-inline" style="float:right"');?>
					<fieldset>
						<input name="start_date" value="" class="datepicker span2" type="text" placeholder="<?php echo lang('start_date');?>"/>
						<input name="end_date" value="" class="datepicker span2" type="text"  placeholder="<?php echo lang('end_date');?>"/>
...
<table class="table table-striped">
    <thead>
		<tr>
			...
			<th><?php echo sort_url('order', 'order_number', $sort_by, $sort_order, $code, config_item('admin_folder')); ?></th>
			<th><?php echo sort_url('bill_to', 'bill_lastname', $sort_by, $sort_order, $code, config_item('admin_folder')); ?></th>
			<th><?php echo sort_url('ship_to', 'ship_lastname', $sort_by, $sort_order, $code, config_item('admin_folder')); ?></th>
			<th><?php echo sort_url('ordered_on','ordered_on', $sort_by, $sort_order, $code, config_item('admin_folder')); ?></th>
			<th><?php echo sort_url('status','status', $sort_by, $sort_order, $code, config_item('admin_folder')); ?></th>
			<th><?php echo sort_url('total','total', $sort_by, $sort_order, $code, config_item('admin_folder')); ?></th>
			<th></th>
	    </tr>
	</thead>
	...
	<tr>
		...
		<td style="span2">
			<?php echo form_dropdown('status', config_item('order_statuses'), $order->status, 'id="status_form_'.$order->id.'" class="span2" style="float:left;"'); ?>
		...
		<td>
			<a class="btn btn-small" style="float:right;"href="<?php echo site_url('admin/orders/order/'.$order->id);?>"><i class="icon-search"></i> <?php echo lang('form_view')?></a>
		</td>
	</tr>
    <?php endforeach; ?>
    </tbody>
