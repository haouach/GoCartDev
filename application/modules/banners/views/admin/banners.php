...
<a style="float:right;" class="btn" href="<?php echo site_url('admin/banners/form'); ?>"><i class="icon-plus-sign"></i> <?php echo lang('add_new_banner');?></a>
		...
		<tr id="banners-<?php echo $banner->id;?>">
			...
			<td>
				<div class="btn-group" style="float:right">
					<a class="btn" href="<?php echo  site_url('admin/banners/form/'.$banner->id);?>"><i class="icon-pencil"></i> <?php echo lang('edit');?></a>
					<a class="btn btn-danger" href="<?php echo  site_url('admin/banners/delete/'.$banner->id);?>" onclick="return areyousure();"><i class="icon-trash icon-white"></i> <?php echo lang('delete');?></a>
				</div>
			</td>
		</tr>
	<?php endforeach; ?>
