...
<a style="float:right;" class="btn" href="<?php echo site_url('admin/banners/banner_form/'.$banner_collection_id); ?>"><i class="icon-plus-sign"></i> <?php echo lang('add_new_banner');?></a>
<a style="float:right; margin-right:10px;" class="btn" href="<?php echo site_url('admin/banners/'); ?>"><?php echo lang('banner_collections');?></a>
		...
		<tr id="banners-<?php echo $banner->banner_id;?>">
			...
			<td>
				<div class="btn-group" style="float:right">
					<a class="btn" href="<?php echo site_url('admin/banners/banner_form/'.$banner_collection_id.'/'.$banner->banner_id);?>"><i class="icon-pencil"></i> <?php echo lang('edit');?></a>
					<a class="btn btn-danger" href="<?php echo  site_url('admin/banners/delete_banner/'.$banner->banner_id);?>" onclick="return areyousure();"><i class="icon-trash icon-white"></i> <?php echo lang('delete');?></a>
				</div>
			</td>
		</tr>
	<?php endforeach; ?>
